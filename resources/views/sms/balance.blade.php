...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="m-heading-1 border-green m-bordered">
            ...
            <h2><small>Current Balance:</small><b> {{ number_format($current_balance->Curent_balance)}}</b> <small>TSH</small> </h2>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{date('D d M Y', strtotime($exp->created_at))}}</td>
                                    <td>{{number_format($exp->amount)}} TSH</td>
                                    <td>{{number_format($exp->new_balance)}} TSH</td>
                        ...
                        <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{number_format($tp->new_balance)}}</td>
                                    <td>{{$tp->transaction_for}}</td>
                                </tr>
                                @endforeach
