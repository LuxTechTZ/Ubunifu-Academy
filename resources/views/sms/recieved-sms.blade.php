    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>Recieved SMS
                    <small>Text Messages Recieved</small>
                </h1>
            </div>
            <!-- END PAGE TITLE -->
            <!-- BEGIN PAGE TOOLBAR -->
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Recieved SMS</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase">Recieved SMS</span>
                        </div>
                        <div class="actions">
