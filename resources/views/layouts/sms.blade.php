...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" >
        ...
        <meta content="@hasSection('template_title')@yield('template_title') | @endif {{ config('app.name', Lang::get('titles.app')) }}" name="description" />
        <meta content="Felix Mgeni" name="author" />
        <!-- System Links -->
        {{-- CSRF Token --}}
