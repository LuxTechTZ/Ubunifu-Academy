...
<ul class="u-list-inline g-color-gray-dark-v6">
  ...
  <li class="list-inline-item">
    <span class="g-valign-middle">Book Categories</span>
  </li>
</ul>
</div>
<!-- End Breadcrumb-v1 -->
...
@section('content')
<div class="g-pa-20">
    <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Create Books Category</h1>

    <div class="row">
        <!-- 1-st column -->
        <div class="col-md-12">
            <!-- Basic Text Inputs -->
            <form method="POST" action="{{route('store_book_category')}}" enctype="multipart/form-data">
                @csrf
