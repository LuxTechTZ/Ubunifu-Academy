...
<ul class="u-list-inline g-color-gray-dark-v6">
  ...
  <li class="list-inline-item">
    <span class="g-valign-middle">Edit Book Details</span>
  </li>
</ul>
</div>
<!-- End Breadcrumb-v1 -->
...
<div class="g-pa-20">
    <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-28">Edit Book</h1>
                  ...
                  <!-- Default Input -->
                    <div class="row">
                        ...
                        <div class="form-group g-mb-30 col-md-6">
                            <label class="g-mb-10" for="inputGroup-1_1">Book Title</label>
                            <div class="g-pos-rel">
                              <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
                                <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                </span>
                              <input id="title" required value="{{$book->title}}"
                        ...
                        <div class="form-group g-mb-30 col-md-6">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="quote" required value="{{$book->quote}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="text"
                                     name="quote">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-6">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="about" value="{{$book->about}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="text"
                                     name="about">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-4">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="author" required value="{{$book->author}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="text"
                                     name="author">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-4">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="pages" required value="{{$book->pages}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="number"
                                     name="pages">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-4">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="weight" value="{{$book->weight}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="text"
                                     name="weight">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-4">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="price" required value="{{$book->price}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="number"
                                     name="price">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-4">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="isbn" required value="{{$book->isbn}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="text"
                                     name="isbn">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-4">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="language" required value="{{$book->language}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="text"
                                     name="language">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-6">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="publisher" required value="{{$book->publisher}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="text"
                                     name="publisher">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-6">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <input id="date_published" required value="{{$book->date_published}}"
                                     class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                     type="date"
                                     name="date_published">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-12">
                            ...
                            <div class="g-pos-rel">
                              ...
                              <textarea class="js-text-editor" name="description"
                                   data-height="156" data-placeholder="start typing here">{!! $book->description !!}"</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group g-mb-30 col-md-6">
                            ...
                            <img style="width: 100%" src="{{url('/')}}/{{Storage::url($book->back_image)}}" alt="{{$book->title}}"">
