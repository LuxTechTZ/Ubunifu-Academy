      ...
      <div class="d-flex align-self-center align-items-center">
        ...
        <div class="u-select--v1 g-pr-20">
          <select class="js-select u-select--v1-select w-100" style="display: none;">
            ...
            <option data-content='<span class="d-flex align-items-center"><span class="u-badge-v2--md g-pos-stc g-transform-origin--top-left g-bg-gray-light-v6 g-mr-8--sm"></span><span class="g-hidden-sm-down g-line-height-1_2 g-color-black">Archive</span></span>'>Published</option>
          </select>
                    ...
                    <div class="row">
                        <div class="form-group g-mb-30 col-md-6">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <input id="name" required value="{{$edit->name}}"
                                         class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                         type="test"
                                         name="name">
                            </div>
                        ...
                        <div class="form-group g-mb-30 col-md-6">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <input id="order" required value="{{$edit->id}}"
                                         class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10"
                                         type="number"
                                         name="order">
                            </div>
