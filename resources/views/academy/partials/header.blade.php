    ...
    <nav class="navbar no-gutters g-pa-0">
      <div class="col-auto d-flex flex-nowrap u-header-logo-toggler g-py-12">
        ...
        <a href="{{url('/')}}" class="navbar-brand d-flex align-self-center g-hidden-xs-down g-line-height-1 py-0 g-mt-5">
          ...
          <img style="max-width: 150px" src="{{url('/')}}/logo.png" alt="Ubunifu Academy Logo" class="logo-default" />
        </a>
        <!-- End Logo -->

        <!-- Sidebar Toggler -->
        <a class="js-side-nav u-header__nav-toggler d-flex align-self-center ml-auto" href="#!" data-hssm-class="u-side-nav--hidden u-sidebar-navigation-v1--hidden" data-hssm-body-class="u-side-nav-hidden" data-hssm-is-close-all-except-this="true" data-hssm-target="#sideNav">
      ...
      <div class="col-auto d-flex g-py-12 g-pl-40--lg ml-auto">
        ...
        <div class="g-pos-rel g-hidden-sm-down g-mr-5">
            ...
            <ul class="p-0 mb-0">
              ...
              <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                <div class="d-flex g-mr-15">
                  <img class="g-width-40 g-height-40 rounded-circle" src="{{url('/')}}/academy/assets2/img-temp/100x100/img5.jpg" alt="Image Description">
                </div>
          ...
          <i class="hs-admin-time icon-clock g-mr-5"></i> <small>5 Min ago</small>
              ...
              <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                <div class="d-flex g-mr-15">
                  <img class="g-width-40 g-height-40 rounded-circle" src="{{url('/')}}/academy/assets2/img-temp/100x100/img6.jpg" alt="Image Description">
                </div>
          ...
          <i class="hs-admin-time icon-clock g-mr-5"></i> <small>22 Min ago</small>
              ...
              <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                <div class="d-flex g-mr-15">
                  <img class="g-width-40 g-height-40 rounded-circle" src="{{url('/')}}/academy/assets2/img-temp/100x100/img7.jpg" alt="Image Description">
                </div>
      ...
      <span class="g-hidden-sm-down">{{Auth::User()->first_name}} {{Auth::User()->last_name}}</span>
        ...
        <i class="hs-admin-bell"></i>
              ...
              <li class="g-mb-10">
                <a class="media g-color-primary--hover g-py-5 g-px-20" href="{{ url('/profile/'.Auth::user()->name) }}">
                  <span class="d-flex align-self-center g-mr-12">
