...
<main>
		<section id="hero_in" class="general">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>About Ubunifu Academy</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
		...
		<div class="container margin_120_95">
			<div class="main_title_2">
				<span><em></em></span>
				<h2>Why choose Ubunifu Academy</h2>
				<p>We aim at providing sustainable Entrepreneur Education to the East African community .</p>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<a class="box_feat" href="#">
						...
						<p>We have a team of The best and qualified teacher with a decent background in providing quality Video Courses.</p>
					</a>
				</div>
				<div class="col-lg-4 col-md-6">
					<a class="box_feat" href="#">
