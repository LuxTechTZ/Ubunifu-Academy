	...
	<div class="container margin_60_35">
		<div class="row">
			<aside class="col-lg-3" id="sidebar">
				<div class="profile">
					<figure><img src="{{url('/')}}/img/teacher_2_small.jpg" alt="Teacher" class="rounded-circle"></figure>
					...
					<ul>
						<li>Name <span class="float-right">{{$teacher->user->first_name}} {{$teacher->user->last_name}}</span> </li>
						<li>Students <span class="float-right">{{$students}}</span></li>
						<li>Lessons <span class="float-right">{{$lessons}}</span></li>
						<li>Courses <span class="float-right">{{count($teacher->courses)}}</span></li>
					</ul>
				</div>
			</aside>
			<!--/aside -->
