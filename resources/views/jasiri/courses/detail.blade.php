            ...
            <div class="row">
                ...
                <aside class="col-lg-4" id="sidebar">
                    <div class="box_detail">
                        <figure>
                            <a href="https://cdn.jwplayer.com/players/jKMvkpGt-6nzF13qK.html" class="video"><i class="arrow_triangle-right"></i><img src="{{url('/')}}/{{$course->image}}" alt="" class="img-fluid"><span>View course preview</span></a>
                        </figure>
